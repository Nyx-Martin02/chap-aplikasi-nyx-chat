  ...
  <div class="forms">
    <div class="signup-form">
      <form action="./logic/login.php" method="post" class="form-group">
        ...
        <input type="email" placeholder="Masukan Email" name="email" class="form-control inp-email mt-2">

        <input type="password" placeholder="Masukan Password" name="pwd" class="form-control inp-pwd mt-2">
